...
export const MobileMenu = ({ menuOpen, setMenuOpen }) => {
    ...
    return (
        <div className={`fixed top-0 left-0 w-full bg-[rgba(10,10,10,0.8)]  z-40 flex flex-col items-center justify-center
            transition-all duration-300 ease-in-out ${menuOpen ? "h-screen opactiy-100 pointer-events-auto"
           ...
           ${menuOpen ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"} `}>
            ...
            <a
                ...
                onClick={() => setMenuOpen(false)}
                className={`text-2xl font-semibold bg-blue-600 px-6 py-2 rounded-lg text-white my-4 
